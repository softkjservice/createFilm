                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="mt-4">
                        ...
                        <div>
                            ...
                            <a href="#" class="btn btn-success btn-bold px-4 float-right mt-3 mt-lg-0">Zatwierdź zamówienie</a>
                            <a href="#" class="btn btn-secondary btn-bold px-4 float-right mt-3 mt-lg-0">Powróć do edycji</a>
                        </div>
                    </div>
                </div>
            </div>
